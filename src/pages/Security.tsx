                    ...
                    <div className="p-8 sm:p-12">
                        ...
                        <div className="prose prose-lg dark:prose-invert max-w-none mb-12">
                            <p className="text-lg text-gray-600 dark:text-gray-300">
                                At Bloggazers, security is at the core of everything we do. We employ industry-leading security practices to ensure your data remains protected at all times. This page outlines our security measures and commitment to keeping your information safe.
                            </p>
                        </div>
